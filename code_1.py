...
class Reproductor:
    def __init__(self, ventana):
        ...
        self.cargar_listas_de_reproduccion()  # Agregar esta línea para cargar las listas de reproducción al iniciar
    ...
    def cargar_favoritos(self):
        try:
            ...
            print(f"Error al cargar los favoritos: {e}")
        except FileNotFoundError:
            print("Guardadndo en listas_de_reproduccion.json")

    def cargar_listas_de_reproduccion(self):
        try:
            with open("listas_de_reproduccion.json", "r") as archivo:
                datos_listas = json.load(archivo)
                for lista, canciones in datos_listas.items():
                    self.listas_de_reproduccion[lista] = [Cancion(cancion["nombre"], cancion["archivo"]) for cancion in canciones]
        except json.JSONDecodeError as e:
            print(f"Error al cargar las listas de reproducción: {e}")
        except FileNotFoundError:
            print("El archivo 'listas_de_reproduccion.json' no se encontró.")
    ...
    def guardar_favoritos(self):
        try:
            ...
            print("Guardando en listas_de_reproducción.json.")
